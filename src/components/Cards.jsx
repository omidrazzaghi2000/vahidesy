      ...
      {projectsToDisplay.map((project, index) => (
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <img src={project.image_src} alt="Circular Illustration" />
          </div>
          <h2 className="font-poppins mt-2 mb-2 cursor-pointer text-base font-semibold lg:text-xl">
            {project.name}
          </h2>
          </div>
          
          <p className="font-poppins text-sm text-gray-900 align-center">
