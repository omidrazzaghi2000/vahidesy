...
function Contact() {
  ...
  return (
    <div className="pb-4 flex w-full items-center justify-center md:h-screen lg:mb-4">
      <div className="flex flex-col items-center justify-center ">
        ...
        <p className="font-poppins mx-auto px-2 pb-6 text-center text-sm tracking-wider text-gray-900 lg:w-[50%]">
          We'd love to connect and explore exciting opportunities with you!
          Whether you have interesting and creative ideas, or just want to
          chat, please don't hesitate to reach out. Our inbox is open 24/7!
        </p>
